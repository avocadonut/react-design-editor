...
export interface ICanvasOptionProps {
...
export type LinkStateType = 'new' | 'current';

export interface ILinkPropertyProps {
    enabled: boolean,
    type?: string,
    state?: LinkStateType,
}

export type TooltipType = 'default' | 'template';

export interface ITooltipPropertyProps {
    enabled: boolean,
    type?: TooltipType,
    template?: string,
}
...
export interface IAnimationPropertyProps {
    type: AnimationType,
    loop: boolean,
    autoplay: boolean,
    delay: number,
...
export interface IUserPropertyProps {
    userProperty: object,
}

export interface ITriggerPropertyProps {
    enabled: boolean,
    type: string,
    script: string,
    effect: string,
...
export interface IWorkareaOptionProps {
    width?: number,
    height?: number,
    ...
    type?: string,
    layout?: LayoutType,
    link?: ILinkPropertyProps,
    tooltip?: ITooltipPropertyProps,
}
...
export interface IGuidelineOptionProps {
    enabled: boolean
}
...
export interface ICanvasProps {
    ...
    editable?: boolean,
    canvasOption?: ICanvasOptionProps,
    defaultOptions?: object,
    activeSelection?: object,
    zoomEnabled?: boolean,
    minZoom?: number,
    maxZoom?: number,
    propertiesToInclude?: Array<string>,
    guidelineOption?: IGuidelineOptionProps,
    workareaOption?: IWorkareaOptionProps,
    gridOption?: IGridOptionProps,
    ...
    onTooltip?: (tooltipRef: HTMLDivElement, target: fabric.Object) => void,
    onContext?: (contextmenuRef: HTMLDivElement, event: MouseEvent, target: fabric.Object) => void,
    keyEvent?: IKeyboardEventProps,
}
...
export type InteractionModeType = 'selection' | 'grab' | 'drawing' | 'polygon' | 'crop' | 'link';

const defaultCanvasOption: ICanvasOptionProps = {
...
const defaultWorkareaOption: IWorkareaOptionProps = {
    width: 600,
    height: 400,
    workareaWidth: 600,
    workareaHeight: 400,
...
const defaultKeyboardEvent: IKeyboardEventProps = {
    move: true,
    all: true,
    copy: true,
    paste: true,
...
class Canvas extends Component<ICanvasProps, ICanvasState> {
    ...
    videoHandlers = {
        ...
        create: (obj: fabric.Object, src: any) => {
            const { editable } = this.props;
    ...
    drawingHandlers = {
        polygon: {
            ...
            // TODO... polygon resize
            createResize: (target: fabric.Object, points: Array<fabric.Point>) => {
    ...
    contextmenuHandlers = {
        show: debounce(async (e?: MouseEvent, target?: fabric.Object) => {
