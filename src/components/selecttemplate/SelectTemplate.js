...
class ImageMapEditor extends Component {
    ...
    componentDidMount() {
        ...
        this.resizeSensor = new ResizeSensor(this.container, () => {
            ...
            this.canvasRef.handlers.importJSON(JSON.stringify(templates));
        ...
        // this.handlers.onImport(templates);
    ...
    render() {
        ...
        const titleContent = (
            <React.Fragment>
                <span>{i18n.t('selecttemplate.selecttemplate')}</span>
            </React.Fragment>
        );
        const title = (
            <ImageMapTitle
